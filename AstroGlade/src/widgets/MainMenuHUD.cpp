...
namespace ly
{
	...
	mTitleText.SetWidgetLocation({ windowSize.x / 2.f - mTitleText.GetBounds().width/2.f, 100.f});

	mStartButton.SetWidgetLocation({windowSize.x / 2.f-mStartButton.GetBounds().width/2.f, windowSize.y / 2.f});
